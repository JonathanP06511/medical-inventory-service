...
2. **medical-inventory-service**: Deploys the Docker image to Azure Web App.
...
4. **Build and upload Docker images**:
   - Checks for changes in the directories of the specified services (`medical-inventory-service` in this case).
...
services:
  medical-inventory-service:
    build: ../medical-inventory-service
    ports:
      - 3004
